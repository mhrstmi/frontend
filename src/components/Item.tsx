...
import Rlogo from "@assets/images/research-logo.png"
import Klogo from "@assets/images/knowledge-logo.png"
import Llogo from "@assets/images/library-logo.png"
    ...
    <div className={itemClassName}>
        <div className="w-1/6 h-full flex items-center justify-center">
            <div className="w-full h-fit p-1 md:p-5 flex items-center justify-center">
                <img src={data?.abstract ? Rlogo : data?.comment ? Llogo : data.title ? Klogo : ''} className='w-full h-full object-cover' />
            </div>
        </div>
